...
. A criação de FlexVol volume até o tamanho máximo de 300 TIB é suportada usando o Gerenciador de sistema a partir do Cloud Volumes ONTAP 9.12.1 P2.
